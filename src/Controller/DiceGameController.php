...
class DiceGameController extends AbstractController
{
    ...
    public function testRollDice(): Response
    {
        ...
        $dice_array = array();
        $dice_string_array = array();
    
        for ($i = 0; $i < $num; $i++) {
            array_push($dice_array, $die->roll());
            array_push($dice_string_array, $die->getAsString());
        }

        $data = [
            "dice" => $dice_array,
            "dice_string_array" => $dice_string_array
        ];
    ...
    public function testRollDiceMany(string $num): Response
    {
        $die = new DiceGraphic();
        $num = intval( $num );  
